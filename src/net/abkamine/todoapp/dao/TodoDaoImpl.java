package net.abkamine.todoapp.dao;
...
import net.abkamine.todoapp.utils.JDBCUtils;
import netabkamine.todoapp.model.Todo;
...
public class TodoDaoImpl implements TodoDao {
	...
	private static final String INSERT_TODOS_SQL = "INSERT INTO todos"
			+ "  (title, username, description, target_date,  status) VALUES " + " (?, ?, ?, ?, ?);";
